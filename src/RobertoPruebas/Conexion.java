...
//        
   ...
   public boolean existeCliente(String nit) throws SQLException{      
    ...
    public DefaultTableModel obtenerListado_Trabajadores() throws SQLException{
     ...
     */
    public String[] obtenerTrabajadorDeuda(String dpi, String nombre) throws SQLException
    {
        String[] datos=null;
        conectar();
        Statement instruccion = conexion.createStatement();
     ...
     */
    public void insertarAdelanto(int trabajador, double cantidad, boolean anticipo) throws SQLException
    {
        conectar();
        Statement instruccion = conexion.createStatement();
        if(anticipo)
     ...
     * @throws SQLException 
     */
    public int obtenerMesActual() throws SQLException{
        int mes=0;
        conectar();
        Statement instruccion = conexion.createStatement();
    ...
    public double obtenerPrestamoMes(int trabajador, boolean anticipo, boolean total) throws SQLException{
        double prestamo=0;
        conectar();
        Statement instruccion = conexion.createStatement();
        ResultSet resultado;
     ...
     * @throws SQLException 
     */
    public void modificarAdelanto(int trabajador, double cantidad, boolean anticipo) throws SQLException
    {
        conectar();
        Statement instruccion = conexion.createStatement();
        if(anticipo)
